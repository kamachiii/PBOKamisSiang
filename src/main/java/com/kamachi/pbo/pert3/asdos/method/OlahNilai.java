 ...
 */
package com.kamachi.pbo.pert3.asdos.method;
...
public class OlahNilai {
    ...
    public static void main(String[] args) {
        Object[][] data_nilai = {{"Fawwaz", 95.5f}, {"Inaya", 80.2f}, {"Firda", 70.3f}, {"Bedu", 50.3f},};
        System.out.println("=========================================================");
        ...
        for (int i = 0; i < data_nilai.length; i++) {
            ...
            float nilai = (float) data_nilai[i][1];// konversi float ke int untuk fungsi penilaian
